...
export class MailEntry extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="component-mail-entry row no-gutters p-2" onClick={this.props.onClick}>
                ...
                <div className="col pl-2">
                    <div className="row no-gutters mb-1 align-items-start">
                    ...
                    <div className="row no-gutters mt-1 align-items-end">
